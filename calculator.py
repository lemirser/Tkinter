...
button_total = Button(root, text="=", padx=91, pady=20, command=get_total)
button_clear = Button(root, text="Clear", padx=79, pady=20, command=lambda: clear_entry())
...
button_total.grid(row=5, column=1, columnspan=2)
